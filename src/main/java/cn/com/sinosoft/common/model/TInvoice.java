...
public class TInvoice  implements java.io.Serializable {
    ...
    public TInvoice(String id, String applyUser, Date applyTime, String customContract, String type, float total, String state, String checkUser, String createUser, Date createTime) {
        this.id = id;
